...
- **RF-20 (NUEVO):** Al registrarse, el sistema solicitará intereses culinarios y nivel de conocimiento del usuario.
- **RF-24 (NUEVO):** El sistema permitirá categorizar recetas por ocasión especial (ej: Navidad, San Valentín, cumpleaños).
...
- **RF-23 (NUEVO):** Al publicar una receta, el sistema deberá solicitar un campo obligatorio donde el usuario indique el nombre del autor de la receta (persona o fuente), y este dato deberá mostrarse en el detalle público de la receta.
...
- **RF-22 (NUEVO):** El sistema permitirá reportar comentarios inapropiados; el administrador verá el detalle de reportes por usuario y aplicará acciones (ej: suspensión).
- **RF-25 (NUEVO):** El administrador contará con un tablero con recetas pendientes de aprobación para gestionar su publicación.
